...
_ALL_CHECKS: list[Callable[[GTMContainer], CheckResult]] = [
    ...
    check_duplicate_firing_triggers, check_multiple_google_analytics_tags,
]

def run_audit(container: GTMContainer) -> AuditReport:
    return AuditReport(container_id=container.container_id, container_name=container.name,
